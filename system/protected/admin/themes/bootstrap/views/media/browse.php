...
<div id="wrapper">
	...
	<div id="columns">
		...
		<div class="pin">
			<a href="javascript:void(0)" onclick="selectImage('<?php echo $image->url ?>')">
			...
			<p>
				...
				<strong>File size</strong>: <span id="fileSize"><?php echo SizeHelper::calculate($image->size) ?></span> <br>
			</p>
		</div>
		<?php endforeach ?>
	</div>
...
<script>
	function selectImage(url){
		...
		var fileUrl = '<?php echo WEBSITE ?>'+url;
